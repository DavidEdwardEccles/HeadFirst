public class PhraseOMatic {
    public static void main (String[] args) {
        ...
        // make thress sets of words to choose from. add your own!
    ...
    var x = wordListOne.length;
    System.out.println("The length of wordListOne is " + x);

    var y = wordListTwo.length;
    System.out.println("The length of wordListTwo is " + y);
    
    var z = wordListThree.length;
    System.out.println("The length of wordListThree is " + z);
